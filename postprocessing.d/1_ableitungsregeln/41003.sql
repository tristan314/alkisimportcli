...
FROM (
	...
	FROM ax_halde o
	LEFT OUTER JOIN ap_pto t ON o.gml_id = ANY(t.dientzurdarstellungvon) AND t.art='Halde_LGT' AND t.endet IS NULL
	LEFT OUTER JOIN ap_darstellung d ON o.gml_id = ANY(d.dientzurdarstellungvon) AND d.art='Halde_LGT' AND d.endet IS NULL
